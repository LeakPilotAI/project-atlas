...
def test_ui_consolidates_durable_status_without_live_unlock(tmp_path):
    ...
    members.write_text(json.dumps({"event":"membership","trade_id":"t1","challengers":["trend_regime"]})+"\n",encoding="utf-8")
    ...
    history.write_text(json.dumps({"event":"v6_forward_evidence_snapshot","timestamp":"2026-09-15T00:00:00+00:00","evidence":{"forward":{"trend_regime":{"closed":25,"expectancy":0.1,"uncertainty_supports_positive_edge":False}},"exit_replay":{"path_coverage":0.4},"shadow_paper":{"prospective_nomination_count":1}}})+"\n",encoding="utf-8")
