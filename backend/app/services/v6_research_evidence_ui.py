...
def research_evidence_ui(*,history_path:Path=HISTORY_PATH,**status_paths:Any)->dict[str,Any]:
    ...
    diversity=diversity_report(**common);longitudinal=diversity_trends(**common);fixed=fixed_window_diversity(**common)
