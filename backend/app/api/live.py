...
async def live() -> Dict[str, Any]:
    ...
    payload = {
        ...
        "gates": {
            ...
            "scalp_tp_r": cfg.get("scalp_tp_r", getattr(settings, "perp_micro_scalp_tp_r", 0.6)),
            "be_after_r": cfg.get("be_after_r", getattr(settings, "perp_micro_be_after_r", 0.3)),
            "lock_after_r": cfg.get("lock_after_r", getattr(settings, "perp_micro_lock_after_r", 0.5)),
            "lock_r": cfg.get("lock_r", getattr(settings, "perp_micro_lock_r", 0.2)),
